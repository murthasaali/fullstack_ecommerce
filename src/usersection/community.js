                            ...
                            return (
                                <>
                                    ...
                                    <div className='w-full  backdrop-blur-lg    h-fit p-1 flex flex-col gap-2 ' key={item._id}>
                                        ...
                                        <div className='w-full md:h-[450px]   h-auto  bg-opacity-50 md:gap-4 gap-1  border-[1px] backdrop-blur-sm relative rounded-3xl flex flex-col  justify-center px-4 items-start'>
